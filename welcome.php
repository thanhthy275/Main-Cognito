...
<nav class="navbar navbar-expand-lg navbar-light bg-light bg-transparent" id="gtco-main-nav">
    <div class="container"><a class="navbar-brand">Cognito.vn</a>
        <button class="navbar-toggler" data-target="#my-nav" onclick="myFunction(this)" data-toggle="collapse"><span
                class="bar1"></span> <span class="bar2"></span> <span class="bar3"></span></button>
        <div id="my-nav" class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item"><a class="nav-link" href="#">Trang chủ</a></li>
                <li class="nav-item"><a class="nav-link" href="findtutor.php">Tìm gia sư</a></li>
                <li class="nav-item"><a class="nav-link" href="#about">Tìm lớp học</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5" style="margin-top:50px">
                ...
                <h3>  Với slogan "Để lớp 12 của bạn không cô đơn", học sinh có thể chủ động học tập một cách hiệu quả cùng với các bạn học sinh khác từ khắp cả nước với sự giúp đỡ của các cố vấn học tập</h3> 
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <a href="#">Tìm hiểu thêm <i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
        </div>
    </div>
</div>
